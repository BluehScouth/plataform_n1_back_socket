...
import {WebsocketbotohmegaController} from './controllers';
import {WebSocketServer} from './websocket.server';

// tslint:disable:no-any

export class ChatwebsocketApplication extends Application {
  ...
  constructor(options: ApplicationConfig = {}) {
    ...
    // Add a route
    const ns = wsServer.route(WebsocketbotohmegaController, /^\/Websocketbotohmega\/\d+$/);
    ns.use((socket, next) => {
      console.log(
